...
.fx{
    ...
    text-decoration: none;
        ...
        <table> 
            <tr><th colspan='4'><h3>Pedido Separação</h3></th></tr>
            
            <tr><th colspan='2'>Cliente</th><td colspan='2'><?php echo $nome;?></td></tr>
           
            <tr><th colspan='4'><h4>Pedido N°. <?php echo $id_pedido; ?></h4></th></tr>
            <tr>
...
?>
            <tr><td colspan="4"><button class="bt" onclick="window.history.go(0);">Atualizar</button></td></tr>
        </table>
        </section>
