 ...
 if($id_produto_){
    ...
    $salvar = $con->pesquisar("INSERT INTO `_pedido_order`(`id_order`, `id_produto`, `id_pedido`, `id_estoque`, `quantidade`, `id_funcionario`,`unidade`,`volume`) VALUES (null,'$id_produtos','$id_pedido','0','$quantidades','$id_funcionario','$unidade','$volume')");
