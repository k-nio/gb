<link rel="stylesheet" type="text/css" href="../../../_CSS/_footer.css"/>
...
<?php
$var = 4;
include_once '../../../conection/_conection.php';
include_once '../../../conection/_login_autentication.php';
...
if($action){
  ...
  if($quantidade_total == 0){
    ...
    if($quantidade_total < 0){
       ...
       $insert_pedido = $con->pesquisar("INSERT INTO `_pedido_order`(`id_order`, `id_produto`, `id_pedido`, `id_estoque`, `quantidade`, `id_funcionario`, `volume`, `unidade`, `status`) VALUES (null,'$id_produto','$id_pedido','$id_estoque_','$quantidade','$id_funcionario','$volume','$unidade','Concluído')");
        $btn = "Continuar separando";
       $back = -1;
    }
}
?>
<link rel="stylesheet" href="../_CSS/_separar_portrait_1.css"/>
<section id="close-pedido">
    <div id="interface-s">
        <button onclick="window.history.go(<?php echo $back;?>);"><?php echo $btn; ?></button>
        
    </div>    
</section>

<footer class="no-print">
     <h5>  IMBA química @ todos os direitos reservados 2022.</h5>
</footer>