...
<section id="display-ord">
    ...
    <form id="id-ord" action="./_show.php?menu-consulta=4" method="post"></form>
    <form id="id-rel" action="./_show.php?menu-consulta=5" method="post"></form>
      ...
      if($status){
       ...
       ?>
        <tr>
            ...
            <td><button type="submit" name="rel" form="id-rel" value="<?php echo $ord; ?>">Relatório</button></td>
